...
if (isset($_POST['btn_pengumuman'])) {
  if (updatePengumuman($_POST) > 0) {
    $_SESSION['massage'] = 'Pengumuman Berhasil Diupdate';
          ...
          <div class="row">
            <div class="col-lg-8">
              <form action="" method="post" enctype="multipart/form-data">
                <input value="<?= $_GET['id']; ?>" type="hidden" class="form-control" id="id" name="id">
                <div class="mb-3">
                  <label for="judul" class="form-label">Judul</label>
                  <input value="<?= $data['judul']; ?>" type="judul" class="form-control" id="judul" name="judul">
                </div>
                <div class="mb-3">
                  <label for="isi" class="form-label">Isi pengumuman</label>
                  <input value="<?= $data['isi_pengumuman']; ?>" type="text" class="form-control" id="isi" name="isi">
                </div>

                <div class="mb-3">
                  <label for="date" class="form-label">tgl </label>
                  <input value="<?= $data['tgl']; ?>" type="date" class="form-control" id="date" name="tgl" placeholder="Masukkan date">
                </div>
                <div class="mb-3">
                  <label for="foto" class="form-label">Foto</label>
                  <input value="<?= $data['foto']; ?>" accept="img/png,image/jpg,image/jpeg" type="file" class="form-control" id="foto" name="gambar" placeholder="name@example.com">
                </div>
                <!-- /.col -->
                <div class="col-4 ">
                  <button type="submit" class="btn btn-primary btn-block" name="btn_pengumuman">Udpate Pengumuman</button>
                </div>
                <!-- /.col -->
              </form>
            </div>
