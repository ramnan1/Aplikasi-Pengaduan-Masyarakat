...
if (isset($_POST['btn_berita'])) {
  if (createBerita($_POST) > 0) {
    $_SESSION['massage'] = 'Berita Berhasil Ditambahkan';
            ...
            <div class="col-lg-8">
              <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <textarea name="isi" id="isi" cols="30" rows="5" type="text" class="form-control" required></textarea>
                </div>
                ...
                <button type="submit" name="btn_berita" class="btn btn-primary mb-5">Create Berita</button>
              </form>
            </div>
          </div>
          <!-- Content Row -->
